...
void ordinaDate(Tratta *t, size_t nT);
void ordinaCodici(Tratta *t, size_t nT);
void ordinaArrivi(Tratta *t, size_t nT);
void ordinaPartenze(Tratta *t, size_t nT);
void cercaPartenze(Tratta *t, size_t nT, char *query);
void stampa(Tratta *t, size_t nT, EnumMod mod);

int main()
{
    char comandi[][MAX_STR + 1] = {"stampa", "data", "codice", "partenza", "capolinea", "cerca", "fine"};
    ...
    do
    {
        ...
        case e_OrdinaDate:
            ordinaDate(tratte, nTratte);
            break;

        case e_OrdinaPartenza:
            ordinaPartenze(tratte, nTratte);
            break;

        case e_ordinaCodice:
            ordinaCodici(tratte, nTratte);
            break;

        case e_OrdinaArrivo:
            ordinaArrivi(tratte, nTratte);
            break;
